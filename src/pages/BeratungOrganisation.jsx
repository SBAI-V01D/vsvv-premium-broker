      ...
      <div className="px-6 py-5 border-b border-border bg-card shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-[hsl(var(--primary))] tracking-tight">Berater &amp; Organisation</h1>
              <p className="text-xs text-muted-foreground">{orgs.length} Organisationen · {advisors.length} Berater</p>
            </div>
          </div>
