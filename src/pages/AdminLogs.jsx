      ...
      <div className="px-6 py-5 border-b border-border bg-card shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-[hsl(var(--primary))] tracking-tight">Enterprise Audit Monitor</h1>
              <p className="text-xs text-muted-foreground">Prozess-Observability · Guard Analytics · Lifecycle Intelligence</p>
            </div>
          </div>
          <div className="flex gap-2">
            ...
            <Button variant={onlyCritical ? 'default' : 'outline'} size="sm" onClick={() => setOnlyCritical(v => !v)} className="gap-2">
              <Zap className="w-3.5 h-3.5" /> Nur Critical
            </Button>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <Select value={filterLevel} onValueChange={setFilterLevel}>
            <SelectTrigger className="w-36 h-8 text-xs"><SelectValue placeholder="Audit Level" /></SelectTrigger>
            <SelectContent>
          ...
          <Select value={filterGuard} onValueChange={setFilterGuard}>
            <SelectTrigger className="w-36 h-8 text-xs"><SelectValue placeholder="Guard Result" /></SelectTrigger>
            <SelectContent>
          ...
          <Select value={filterProcess} onValueChange={setFilterProcess}>
            <SelectTrigger className="w-44 h-8 text-xs"><SelectValue placeholder="Prozess-Typ" /></SelectTrigger>
            <SelectContent>
