    ...
    try {
      extracted = await base44.integrations.Core.InvokeLLM({
        ...
        prompt: [
          ...
          'JEDE Police MUSS im Dokument folgendes haben:',
          '  1. Einen expliziten Produktnamen (z.B. "myFlex Spitalversicherung Balance")',
          '  2. Einen eigenen CHF-Monatsbetrag ODER Jahresbetrag direkt daneben',
          'VERBOTEN zu erfassen: Gesundheitskonto, 24h-Service, Boni, Rabatte, Inklusivleistungen, Grundversicherung KVG (ausser sie hat eine eigene Zeile mit CHF-Betrag)',
