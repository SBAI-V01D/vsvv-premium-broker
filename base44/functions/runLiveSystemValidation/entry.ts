...
Deno.serve(async (req) => {
  try {
    ...
    const REMEDIATION = {
      ...
      'Dossiers haben organization_id':            { root_cause: 'Dossier ohne organization_id. Tenant-Isolation verletzt.', recommended_fix: '1. Auto-Repair starten: leitet organization_id vom Kunden oder Berater ab\n2. Falls nicht automatisch loesbar: manuell im Dossier-Editor setzen\n3. Sicherstellen dass Berater und Kunde korrekte organization_id haben', auto_fix: true, repair_action: 'repair_dossier_org_ids', governance: false },
